...
static int flv_same_video_codec(AVCodecParameters *vpar, int flags)
{
    ...
    case FLV_CODECID_HEVC:  //Modify for HEVC-FLV Support
...
retry_duration:
    ...
    if (st->codecpar->codec_id == AV_CODEC_ID_AAC ||
        ...
        st->codecpar->codec_id == AV_CODEC_ID_HEVC ||  //Modify for HEVC-FLV Support
        ...
        if (st->codecpar->codec_id == AV_CODEC_ID_H264 || st->codecpar->codec_id == AV_CODEC_ID_HEVC || st->codecpar->codec_id == AV_CODEC_ID_MPEG4) {  //Modify for HEVC-FLV Support
            // sign extension
        ...
        if (type == 0 && (!st->codecpar->extradata || st->codecpar->codec_id == AV_CODEC_ID_AAC ||
            st->codecpar->codec_id == AV_CODEC_ID_H264 || st->codecpar->codec_id == AV_CODEC_ID_HEVC)) {  //Modify for HEVC-FLV Support
            AVDictionaryEntry *t;
